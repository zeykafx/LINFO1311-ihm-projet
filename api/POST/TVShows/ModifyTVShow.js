...
export const ModifyTVShow = (req, res, next) => {
    ...
    if( req &&
        ...
        pool.query('SELECT * FROM public.tvshows WHERE id=$1', [req.body.id], (error, results) => {
            ...
            pool.query('UPDATE public.tvshows SET name=$1, director=$2, "coActors"=$3, "releaseDate"=$4, languages=$5, description=$6, "tv_channels"=$7, "streaming_services"=$8, "actorRole"=$9 WHERE id=$10', 
            [
                req.body.name,
                req.body.director,
                req.body.coActors,

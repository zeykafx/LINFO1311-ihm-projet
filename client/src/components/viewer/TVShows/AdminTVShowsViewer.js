...
function AdminTVShowsViewer({}) {
    ...
    return (
        ...
        { (visibleModifyModal || visibleDeleteModal) &&
            <div className="modal-container">
                ...
                <ModalWrapper
                    ...
                    onPressClose={() => {setVisibleModifyModal(false); setTVShowToModify({})}}
                >  
                ...
                onPressClose={() => {setVisibleDeleteModal(false); setTVShowToDelete({})}}
                >
        ...
        <div className="AMV-container">
            { loading 
            ? <Loader color="rgb(94, 94, 94)" size={30} noAspectRatio={true} label="Fetching the TV Shows..."/>
            :
            <>
                    ...
                    <div className="TVShowInfosContainer">
                        ...
                        <div className="TVShowTextContainer">
                            ...
                            <div className="twoInfosContainer">
                                ...
                                <h3>Released on the {getReadableDateFromMilliTime(tvshow.releaseDate)}</h3>
                            </div>
                            ...
                            { tvshow.tv_channels.map((tv_channel) => {
                                return <div className="tvChannelBubble">{tv_channel}</div>
                            })
                            }
                            </div>
                            ...
                            { tvshow.streaming_services.map((streaming_service) => {
                                return <div className="streamingServiceBubble">{streaming_service}</div>
                            })
                            }
                            </div>

    ...
    return (
        <>
            ...
            <>
                ...
                <p className="description-text">Once pressed, the movie with the name <b>"{movieData.name}"</b> will be permanently deleted. It won't be recoverable nor accessible.</p>

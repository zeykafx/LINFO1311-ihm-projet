...
export const Movie = (props) => {
    ...
    useEffect(() => {
        ...
        fetch("/api/movies/client/getFromID", {
            method: "POST",
            ...
            if (response.status){
                setSelectedMovie(response.message);
            }
    ...
    return (
        <Flex
            ...
            >
                ...
                >   
                    <Text color='gray.800' fontWeight='bold' fontSize="4xl"  textAlign={"center"} marginBottom='5px'>{selectedMovie.name}</Text>
                    <Box
                        overflow={"hidden"}
                        borderRadius={"5px"}
                        shadow={"md"}
